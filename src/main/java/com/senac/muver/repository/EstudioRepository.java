...
public interface EstudioRepository extends CrudRepository<Estudio, Integer> {
	...
	void alterar(String nome, String email, String senha, byte[] fotoPerfilByte, String linkFb, String linkIg, String descricao);

	@Transactional
	@Modifying
	@Query(value = "UPDATE estudio e SET e.localizacao= :localizacao, e.disponibilidade= :disponibilidade where e.idestudio = :id", nativeQuery = true)
	void alterarEstudio(String localizacao,String disponibilidade, int id);
